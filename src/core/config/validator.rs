...
pub enum ConflictError {
    ...
    #[error("'{from_group_name}.{resource_type}.{from_id}' and '{to_group_name}.{resource_type}.{to_id}' target same resource(s)")]
    ExpliciteError{
    ...
    #[error("'{from_group_name}.{resource_type}.{from_id}' already covers '{to_group_name}.{resource_type}.{to_id}' resource")]
    WildcardError{
        from_group_name: String,
        from_id: Identifier,
        to_group_name: String,
